...
(function (root, factory) {
    ...
    /**
     * Bind an event handler to the â€œchangeâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œchangeâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œclickâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œclickâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œdblclickâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery "â€œdblclickâ€" event.
     */
    ...
    /**
     * Bind an event handler to the â€œfocusâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery "â€œfocusâ€" event.
     */
    ...
    /**
     * Bind an event handler to the â€œfocusinâ€ event as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œfocusinâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œkeydownâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œkeydownâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œkeyupâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œkeyupâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œloadâ€ JavaScript event as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œloadâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œmousedownâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmousedownâ€ event.
     */
     ...
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmouseenterâ€ event.
     */
     ...
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmouseleaveâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œmousemoveâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmousemoveâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œmouseoutâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmouseoutâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œmouseoverâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmouseoverâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œmouseupâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œmouseupâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œresizeâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œresizeâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œscrollâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œscrollâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œselectâ€ JavaScript event, or trigger that event on an element as an Observable sequence.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œselectâ€ event.
     */
    ...
    /**
     * Bind an event handler to the â€œunloadâ€ JavaScript event as an Observable sequence.  This is deprecated as of jQuery 1.8.
     *
     * @param {Object} [eventData] An object containing data that will be passed to the event handler.
     * @returns {Observable} An Observable sequence which wraps the jQuery â€œunloadâ€ event.
     */
